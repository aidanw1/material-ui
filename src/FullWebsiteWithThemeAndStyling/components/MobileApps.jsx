      ...
      <Grid item container direction="row" justify={matchesMD ? "center" : undefined} className={classes.rowContainer} style={{ marginTop: matchesXS ? "1em" : "2em" }}>
        ...
        <Hidden mdDown>
          <Grid item className={classes.arrowContainer}>
            <IconButton onClick={() => props.setSelectedIndex(3)} component={Link} to="/websites" style={{ backgroundColor: "transparent" }}>
              <img src={forwardArrow} alt="Forward to Website Developmet Page" />
            </IconButton>
          </Grid>
        </Hidden>
      </Grid>
