  ...
  const tabs = (
    <>
      ...
      <Tabs value={value} onChange={handleChange} className={classes.tabContainer} indicatorColor="primary">
        ...
        <Tab aria-owns={anchorEl ? "simple-menu" : undefined} aria-haspopup={anchorEl ? "true" : undefined} onMouseOver={(e) => handleClick(e)} disableRipple className={classes.tab} component={Link} to="services" label="Services" />
        <Tab disableRipple className={classes.tab} component={Link} to="revolution" label="The Revolution" />
        <Tab disableRipple className={classes.tab} component={Link} to="about" label="About Us" />
        <Tab disableRipple className={classes.tab} component={Link} to="contact" label="Contact Us" />
      </Tabs>
      <Button onClick={() => setValue(5)} variant="contained" color="secondary" component={Link} to="estimate" className={classes.button}>
        Free Estimate
      </Button>
      ...
      <SwipeableDrawer classes={{ paper: classes.drawer }} disableBackdropTransition={!iOS} disableDiscovery={iOS} open={openDrawer} onClose={() => setOpenDrawer(false)} onOpen={() => setOpenDrawer(true)}>
        <List disablePadding>
          ...
          <ListItem
            ...
            selected={value === 5}
          >
            <ListItemText component={Link} to="/estimate" className={value === 5 ? [classes.drawerItem, classes.drawerItemSelected] : classes.drawerItem} disableTypography>
              Free Estimate
            </ListItemText>
          </ListItem>
        </List>
