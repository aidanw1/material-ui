...
export default function Revolution() {
  ...
  return (
    <Grid container direction="column">
      ...
      <Grid alignItems="center" item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ marginTop: "5em" }}>
        <Grid item lg>
        ...
        {/* lg tells the grid container to sit side by side until medium breakpoint */}
      ...
      <Grid alignItems="center" item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ marginTop: "10em", marginBottom: "10em" }}>
        {/* lg tells the grid container to sit side by side until medium breakpoint */}
        <Grid lg item container direction="column" style={{ maxWidth: "40em" }}>
          <Grid item>
      ...
      <Grid style={{ backgroundColor: "#B3B3B3", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={consultation} alt="handshake" width="100%" style={{ maxWith: 700 }} />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#FF7373", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
      ...
      <Grid style={{ backgroundColor: "#39B54A", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Review
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={review} alt="magnifying glass" width="100%" style={{ maxWidth: matchesMD ? 300 : 400 }} />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#A67C52", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Design
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={design} alt="paintbrush" style={{ maxWidth: 1000 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#39B54A", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
      ...
      <Grid style={{ backgroundColor: "#FBB03B", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Build
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={build} alt="build" style={{ maxWidth: matchesMD ? 700 : 1000 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#C1272D", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Launch
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={launch} alt="launch" style={{ maxWidth: 200 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#8E45CE", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Maintain
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={maintain} alt="maintain" style={{ maxWidth: 500 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#29ABE2", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <Grid item>
            <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
              Iterate
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={iterate} alt="iterate" style={{ maxWidth: 1000 }} width="100%" />
        </Grid>
      </Grid>
    </Grid>
  );
